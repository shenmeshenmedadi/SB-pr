...
TLS_SERVER_DEFAULT=cache5-sgp1.steamcontent.com
...
bash <(wget --no-check-certificate -qO- https://raw.githubusercontent.com/shenmeshenmedadi/SB-pr/refs/heads/main/sing-box.sh) \$1
EOF
